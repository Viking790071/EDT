...
Procedure AddAndCalculateAdvanceRow(SettlementsAmount, CurrentRow)
	...
	If TabName = "Debitor"
		And OperationType = OperationTypeSupplierAdvanceClearing
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	// Predefined values
	OperationTypeSupplierAdvanceClearing = Enums.OperationTypesArApAdjustments.SupplierAdvanceClearing;
	...
	If Parameters.Property("DebitorAccountingAmount") And Parameters.Property("OperationType") And Parameters.Property("TabName")
		And (Parameters.OperationType = Enums.OperationTypesArApAdjustments.DebtAssignmentToVendor
			Or Parameters.OperationType = Enums.OperationTypesArApAdjustments.SupplierAdvanceClearing) Then
