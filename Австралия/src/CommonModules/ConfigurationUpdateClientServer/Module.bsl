...
#Else
	Result.Insert("UpdateMode", ?(StandardSubsystemsClientCached.ClientRunParameters().FileInfobase, 0, 2));
	Result.Insert("UpdateDateTime", AddDays(BegOfDay(CommonClient.SessionDate()), 1));
#EndIf
...
// Returns a full name of main data processor form InstallUpdates.
//
