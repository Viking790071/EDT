...
// For example if configuration update fails or some problems are detected during the update, the user receives a
// warning and is prompted to eliminate the causes by themselves and try again.
//
// Parameters
...
Procedure WhenDeterminingPageAddressForAccessToUpdateWebsite(PageAddress) Export
	PageAddress = "https://1c-dn.com/library/";
EndProcedure
