	...
	If TypeOf(Data) = Type("Array") Then
		...
		If DecryptedData <> Undefined Then
			For Each Structure In DecryptedData Do
				...
				|	AND DiscountCardTypes.DiscountCardTemplate = &DiscountCardTemplate
				|	AND NOT DiscountCardTypes.DeletionMark
				|;
				|
				|////////////////////////////////////////////////////////////////////////////////
				|SELECT ALLOWED
...
//  discount cards and NotRegisteredDiscountCards.
//
Function FindDiscountCardTypesByDataFromMagneticCardReader(Data, CodeType, KindDiscountCard) Export
