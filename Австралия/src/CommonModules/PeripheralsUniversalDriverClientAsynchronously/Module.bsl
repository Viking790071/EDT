...
Procedure StartDeviceConnectionConnectEnd(ExecutionResult, CallParameters, AdditionalParameters) Export
	...
	If Not ExecutionResult Then
		...
		Except
			...
			Output_Parameters.Clear();
			Output_Parameters.Add(999);
			Output_Parameters.Add(NStr("en = 'An error occurred while calling the <DriverObject.GetError> method.'; ru = 'Ошибка вызова метода <DriverObject.GetError>.';pl = 'Wystąpił błąd podczas wywoływania metody <DriverObject.GetError>.';es_ES = 'Ha ocurrido un error al llamar el método <DriverObject.GetError>.';es_CO = 'Ha ocurrido un error al llamar el método <DriverObject.GetError>.';tr = '<DriverObject.GetError> yöntemini çağırırken bir hata oluştu.';it = 'Si è verificato un errore durante la chiamata <DriverObject.GetError>.';de = 'Ein Fehler ist aufgetreten beim Aufrufen der <DriverObject.GetError> Methode.'") + Chars.LF + ErrorDescription());
			ExecutionResult = New Structure("Result, Output_Parameters", False, Output_Parameters);
			If AdditionalParameters.AlertOnEnd <> Undefined Then
				ExecuteNotifyProcessing(AdditionalParameters.AlertOnEnd, ExecutionResult);
			EndIf;
...
Procedure StartConnectionDeviceParametersSettingEnd(Result, Parameters) Export
	...
	Except
		...
		Output_Parameters.Clear();
		Output_Parameters.Add(999);
		Output_Parameters.Add(NStr("en = 'An error occurred while calling the <DriverObject.Enable> method.'; ru = 'Ошибка вызова метода <DriverObject.Enable>.';pl = 'Wystąpił błąd podczas wywoływania metody <DriverObject.Enable>.';es_ES = 'Ha ocurrido un error al llamar el método <DriverObject.Enable>.';es_CO = 'Ha ocurrido un error al llamar el método <DriverObject.Enable>.';tr = '<DriverObject.Enable> yöntemini çağırırken bir hata oluştu.';it = 'Si è verificato un errore durante la chiamata <DriverObject.Enable>.';de = 'Ein Fehler ist aufgetreten beim Aufrufen der <DriverObject.Enable> Methode.'") + Chars.LF + ErrorDescription());
		ExecutionResult = New Structure("Result, Output_Parameters", False, Output_Parameters);
...
Procedure StartDisableDevice(AlertOnEnd, DriverObject, Parameters, ConnectionParameters, Output_Parameters) Export
	...
	Except
		Output_Parameters.Clear();
		Output_Parameters.Add(999);
		Output_Parameters.Add(NStr("en = 'An error occurred while calling the <DriverObject.Disable> method.'; ru = 'Ошибка вызова метода <DriverObject.Disable>.';pl = 'Wystąpił błąd podczas wywoływania metody <DriverObject.Disable>.';es_ES = 'Ha ocurrido un error al llamar el método <DriverObject.Disable>.';es_CO = 'Ha ocurrido un error al llamar el método <DriverObject.Disable>.';tr = '<DriverObject.Disable> yöntemini çağırırken bir hata oluştu.';it = 'Si è verificato un errore durante la chiamata <DriverObject.Disable>.';de = 'Ein Fehler ist aufgetreten beim Aufrufen der <DriverObject.Disable> Methode.'") + Chars.LF + ErrorDescription());
		ExecutionResult = New Structure("Result, Output_Parameters", False, Output_Parameters);
...
Procedure StartGettingDriverVersion(AlertOnEnd, DriverObject, Parameters, ConnectionParameters, Output_Parameters) Export
	...
	Except
		Output_Parameters.Clear();
		Output_Parameters.Add(999);
		Output_Parameters.Add(NStr("en = 'An error occurred while calling the <DriverObject.GetVersionNumber> method.'; ru = 'Ошибка вызова метода <DriverObject.GetVersionNumber>.';pl = 'Wystąpił błąd podczas wywoływania metody <DriverObject.GetVersionNumber>.';es_ES = 'Ha ocurrido un error al llamar el método <DriverObject.GetVersionNumber>.';es_CO = 'Ha ocurrido un error al llamar el método <DriverObject.GetVersionNumber>.';tr = '<DriverObject.GetVersionNumber> yöntemini çağırırken bir hata oluştu.';it = 'Si è verificato un errore durante la chiamata <DriverObject.GetVersionNumber>.';de = 'Ein Fehler ist aufgetreten beim Aufrufen der <DriverObject.GetVersionNumber> Methode.'") + Chars.LF + ErrorDescription());
		ExecutionResult = New Structure("Result, Output_Parameters", False, Output_Parameters);
		If AlertOnEnd <> Undefined Then
			ExecuteNotifyProcessing(AlertOnEnd, ExecutionResult);
		EndIf;
