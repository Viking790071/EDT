...
//  EnumRef.SMSStatus - matching result
Function MapSMSDeliveryStatus(DeliveryStatusInRow) Export
	
	StatusesCorrespondence = New Map;
	StatusesCorrespondence.Insert("",				Enums.SMSStatus.Outgoing);
	StatusesCorrespondence.Insert("HaveNotSent", Enums.SMSStatus.Outgoing);
	StatusesCorrespondence.Insert("Dispatched",	Enums.SMSStatus.IsSentByProvider);
	StatusesCorrespondence.Insert("Sent",		Enums.SMSStatus.SentByProvider);
	StatusesCorrespondence.Insert("NotSent",	Enums.SMSStatus.NotSentByProvider);
	StatusesCorrespondence.Insert("Delivered",		Enums.SMSStatus.Delivered);
	StatusesCorrespondence.Insert("NotDelivered",	Enums.SMSStatus.NotDelivered);
	
	Result = StatusesCorrespondence[DeliveryStatusInRow];
	Return ?(Result = Undefined, Enums.SMSStatus.ErrorObtainingStatusOfInternetServiceProvider, Result);
