...
Procedure FillAttachmentsAndGenerateHTMLTextBasedOnAttachmentEmail(AttachmentEmail)
	...
	If EmailMessage.ParseStatus = InternetMailMessageParseStatus.ErrorsDetected Then
		CommonClientServer.MessageToUser(NStr("ru = 'Не удалось разобрать почтовое сообщение.'; en = 'Cannot parse the email message.'; pl = 'Nie można przetworzyć wiadomości e-mail.';es_ES = 'No se ha podido analizar el mensaje de correo electrónico.';es_CO = 'No se ha podido analizar el mensaje de correo electrónico.';tr = 'E-posta iletisi çözümlenemiyor.';it = 'Impossibile smontare il messaggio email.';de = 'Kann die E-Mail-Nachricht nicht zerlegen.'"));
		Return;
	EndIf;
...
Procedure GenerateBaseEmailString();
	...
	StringHeader = New FormattedString(NStr("ru = 'Вложение к письму:'; en = 'Email attachment:'; pl = 'Załącznik do wiadomości e-mail:';es_ES = 'Adjunto de correo electrónico:';es_CO = 'Adjunto de correo electrónico:';tr = 'E-posta eki:';it = 'Allegato email:';de = 'E-Mail-Anhang:'"));
