...
Function CreateDataExchange(ExchangePlanName, ParameterString, FilterSettingAsString, DefaultValuesAsString)
...
Function PrepareGetFile(FileId, BlockSize, TransferId, PartQuantity)
	...
	SourceFileNameInTemporaryDirectory = CommonClientServer.GetFullFileName(TemporaryDirectory, File.Name);
	SharedFileName = CommonClientServer.GetFullFileName(TemporaryDirectory, "data.zip");
