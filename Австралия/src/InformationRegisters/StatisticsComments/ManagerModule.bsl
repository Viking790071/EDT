...
Function GetRefManyComments(RefOperation)
	...
	Try
		...
		TooManyComments = NStr("ru = 'Слишком много комментариев';
										|en = 'Too many comments';pl = 'Zbyt dużo komentarzy';es_ES = 'Demasiados comentarios';es_CO = 'Demasiados comentarios';tr = 'Yorum sayısı çok fazla';it = 'Troppi commenti';de = 'Zu viele Kommentare'");
...
Function FindByHash(Hash1, RefOperation)
	Query = New Query;
	Query.Text = "
	|SELECT
