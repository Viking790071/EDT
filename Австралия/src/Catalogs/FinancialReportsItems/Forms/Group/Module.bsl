...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.ReverseSign.Visible = (Parameters.ItemType = Enums.FinancialReportItemsTypes.GroupTotal);
...
Procedure OutputItemTitleOnChange(Item)
	...
	Items.DescriptionForPrinting.Enabled = OutputItemTitle;
	Object.DescriptionForPrinting = ?(OutputItemTitle, Object.DescriptionForPrinting, "Group");
