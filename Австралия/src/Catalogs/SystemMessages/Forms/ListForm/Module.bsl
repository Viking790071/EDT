...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	IsSessionWithSetSeparatorsValues = SaaS.DataSeparationEnabled() 
...
Procedure SendAndReceiveMessages(Command)
	...
	If IsSessionWithSetSeparatorsValues Then
		MessageText = NStr("ru = 'Обработка сообщений возможна только в неразделенном сеансе администратора сервиса.'; en = 'Message handling is available only during a shared session of the SaaS administrator.'; pl = 'Wiadomości mogą być przetwarzane tylko w niepodzielnej sesji administratora usług.';es_ES = 'Mensajes pueden procesarse solo en una sesión no dividida del administrador de servicios.';es_CO = 'Mensajes pueden procesarse solo en una sesión no dividida del administrador de servicios.';tr = 'Mesajlar sadece bölünmemiş bir servis yöneticisi oturumunda işlenebilir.';it = 'La gestione del messaggio è disponibile solo durante una sessione condivisa dell''amministratore SaaS.';de = 'Nachrichten können nur in einer ungeteilten Sitzung des Dienstadministrators verarbeitet werden.'");
