...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(Object.BeginnigDate) Then
		Object.BeginnigDate = CurrentSessionDate();
	EndIf;
...
Procedure FillTemplateOnChange(Item)
	...
	ElsIf ValueIsFilled(FillTemplate)
		...
		Text			= NStr("en = 'Schedule type is changed. The template will be refilled.'; ru = 'Тип графика изменен. Шаблон будет перезаполнен.';pl = 'Rodzaj harmonogramu został zmieniony. Szablon zostanie uzupełniony.';es_ES = 'Tipo de horario está cambiado. El modelo se volverá a rellenar.';es_CO = 'Tipo de horario está cambiado. El modelo se volverá a rellenar.';tr = 'Program türü değiştirildi. Şablon yeniden doldurulacak.';it = 'Il tipo di programma è cambiato. Il modello sarà ricompilato.';de = 'Der Zeitplantyp wurde geändert. Die Vorlage wird neu ausgefüllt.'");
