...
Procedure ChooseAndClose(Command)
	...
	Else
		...
		CommonClientServer.MessageToUser(NStr("en = 'Select workplace'; ru = 'Выберите рабочее место';pl = 'Wybierz miejsce pracy';es_ES = 'Seleccionar el lugar de trabajo';es_CO = 'Seleccionar el lugar de trabajo';tr = 'Çalışma alanı seç';it = 'Selezionare postazione di lavoro';de = 'Arbeitsplatz auswählen'"), Workplace, "Workplace");
