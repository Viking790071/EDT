...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.Configure.Visible = (AccessManagement.HasRole("FullRights") OR AccessManagement.HasRole("SaveUserData"));
	
	NativeLanguagesSupportServer.OnCreateAtServer(ThisObject,, "DeviceList");
...
Procedure RefreshWorkingPlaceParameters()
	...
	If IsBlankString(Title) Then
		...
		Title = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("en = 'Connect and install equipment for workplace %1'; ru = 'Подключение и настройка оборудования для рабочего места %1';pl = 'Podłącz i zainstaluj sprzęt dla miejsca pracy %1';es_ES = 'Conectar e instalar el equipamiento para el lugar de trabajo %1';es_CO = 'Conectar e instalar el equipamiento para el lugar de trabajo %1';tr = 'Çalışma alanı için ekipman bağla ve kur %1';it = 'Connettere e installare l''attrezzatura per la postazione di lavoro %1';de = 'Geräte für den Arbeitsplatz %1 anschließen und Installieren'"),
