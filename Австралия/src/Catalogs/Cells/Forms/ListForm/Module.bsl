...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	DataImportFromExternalSources.OnCreateAtServer(Metadata.Catalogs.Cells, DataLoadSettings, ThisObject);
...
Procedure DataImportFromExternalSources(Command)
	...
	DataLoadSettings.Insert("SelectionRowDescription",	New Structure("FullMetadataObjectName, Type", "Cells", "AppliedImport"));
