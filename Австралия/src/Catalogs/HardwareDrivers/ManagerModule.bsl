...
Procedure ChoiceDataGetProcessing(ChoiceData, Parameters, StandardProcessing)
	...
	NativeLanguagesSupportServer.ChoiceDataGetProcessing(
		...
		Parameters,
		StandardProcessing,
		Metadata.Catalogs.HardwareDrivers);
...
Procedure FillPredefinedItem(DriverHandler, ObjectID = Undefined, DriverTemplateName = Undefined, SuppliedAsDistribution = False, DriverVersion = Undefined) Export
	...
	Except
		Message = NStr("en = 'Predefined item %Parameter% is not found.'; ru = 'Предопределенный элемент ""%Parameter%"" не найден.';pl = 'Nie znaleziono predefiniowanego elementu %Parameter%.';es_ES = 'Artículo predefinido %Parameter% no encontrado.';es_CO = 'Artículo predefinido %Parameter% no encontrado.';tr = 'Öntanımlı öğe %Parameter% bulunamadı.';it = 'L''elemento predefinito ""%Parameter%"" non è stato trovato.';de = 'Vordefinierter Artikel %Parameter% wurde nicht gefunden.'");
