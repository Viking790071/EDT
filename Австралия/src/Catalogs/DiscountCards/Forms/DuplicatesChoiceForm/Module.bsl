...
Procedure SetConditionalAppearance()
	...
	ColorRed		= StyleColors.ErrorNoteText;
	
	// DuplicatingDiscountCardsTablesCardCodeBarcode
	...
	DataFilterItem.LeftValue		= New DataCompositionField("DuplicatingDiscountCardsTables.FoundByBarcode");
	...
	FieldAppearance.Field = New DataCompositionField("DuplicatingDiscountCardsTablesCardCodeBarcode");
	FieldAppearance.Use = True;
	
	// DuplicatingDiscountCardsTablesCardCodeMagnetic
	ItemAppearance = ConditionalAppearance.Items.Add();
	
	DataFilterItem					= ItemAppearance.Filter.Items.Add((Type("DataCompositionFilterItem")));
	DataFilterItem.LeftValue		= New DataCompositionField("DuplicatingDiscountCardsTables.FoundByMagneticCode");
	DataFilterItem.ComparisonType	= DataCompositionComparisonType.Equal;
	DataFilterItem.RightValue		= True;
	DataFilterItem.Use				= True;
	...
	FieldAppearance = ItemAppearance.Fields.Items.Add();
	FieldAppearance.Field = New DataCompositionField("DuplicatingDiscountCardsTablesCardCodeMagnetic");
	FieldAppearance.Use = True;
