...
Procedure BeforeWrite(Cancel, Replacing)
  ...
  OR Not AdditionalProperties.ForPosting.Property("StructureTemporaryTables") Then
	...
	If Not StructureTemporaryTables.Property("RegisterRecordsSuppliersSettlementsChange")
		...
		|	AccumulationRegisterAccountsPayable.PresentationCurrency AS PresentationCurrency,
	...
	Else
		...
		|	AccumulationRegisterAccountsPayable.PresentationCurrency,
	...
	If StructureTemporaryTables.Property("RegisterRecordsSuppliersSettlementsChange") Then
		...
		Query = New Query("DROP RegisterRecordsAccountsPayableChange");
		Query.TempTablesManager = StructureTemporaryTables.TempTablesManager;
		Query.Execute();
...
Procedure OnWrite(Cancel, Replacing)
	...
	|		RegisterRecordsAccountsPayableBeforeWrite.PresentationCurrency AS PresentationCurrency,
	...
	|		RegisterRecordsAccountsPayableOnWrite.PresentationCurrency,
	...
	|	RegisterRecordsSuppliersSettlementsChange.PresentationCurrency,
	...
	If Not TypeOf(Filter.Recorder.Value) = Type("DocumentRef.SupplierInvoice") Then
		InformationRegisters.TasksForUpdatingStatuses.RegisterSupplierInvoicesBasedOnAccountsPayableChange(StructureTemporaryTables.TempTablesManager);
	EndIf;
