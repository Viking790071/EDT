...
Procedure BeforeWrite(Cancel, Replacing)
  ...
  OR Not AdditionalProperties.ForPosting.Property("StructureTemporaryTables") Then
	...
	If Not StructureTemporaryTables.Property("RegisterRecordsIncomeAndExpensesRetainedChange") OR
		...
		|	AccumulationRegisterDeferredIncomeAndExpenditure.PresentationCurrency AS PresentationCurrency,
		|	AccumulationRegisterDeferredIncomeAndExpenditure.Document AS Document,
		|	AccumulationRegisterDeferredIncomeAndExpenditure.BusinessLine AS BusinessLine,
		|	CASE
	...
	Else
		...
		|	RegisterRecordsIncomeAndExpensesRetainedChange.PresentationCurrency AS PresentationCurrency,
		|	RegisterRecordsIncomeAndExpensesRetainedChange.Document AS Document,
		|	RegisterRecordsIncomeAndExpensesRetainedChange.BusinessLine AS BusinessLine,
		...
		|	AccumulationRegisterDeferredIncomeAndExpenditure.PresentationCurrency,
		|	AccumulationRegisterDeferredIncomeAndExpenditure.Document,
		|	AccumulationRegisterDeferredIncomeAndExpenditure.BusinessLine,
		|	CASE
		|		WHEN AccumulationRegisterDeferredIncomeAndExpenditure.RecordType = VALUE(AccumulationRecordType.Receipt)
		|			THEN AccumulationRegisterDeferredIncomeAndExpenditure.AmountIncome
		|		ELSE -AccumulationRegisterDeferredIncomeAndExpenditure.AmountIncome
...
Procedure OnWrite(Cancel, Replacing)
  ...
  OR Not AdditionalProperties.ForPosting.Property("StructureTemporaryTables") Then	
	...
	|		RegisterRecordsIncomeAndExpensesRetainedBeforeWrite.PresentationCurrency AS PresentationCurrency,
	|		RegisterRecordsIncomeAndExpensesRetainedBeforeWrite.Document AS Document,
	|		RegisterRecordsIncomeAndExpensesRetainedBeforeWrite.BusinessLine AS BusinessLine,
	...
	|		RegisterRecordsIncomeAndExpensesRetainedOnWrite.PresentationCurrency,
	|		RegisterRecordsIncomeAndExpensesRetainedOnWrite.Document,
	|		RegisterRecordsIncomeAndExpensesRetainedOnWrite.BusinessLine,
	|		0,
	|		CASE
	...
	|	RegisterRecordsIncomeAndExpensesRetainedChange.PresentationCurrency,
	|	RegisterRecordsIncomeAndExpensesRetainedChange.Document,
	|	RegisterRecordsIncomeAndExpensesRetainedChange.BusinessLine
	|
	|HAVING
