...
Procedure BeforeWrite(Cancel, Replacing)
	...
	If Not StructureTemporaryTables.Property("RegisterRecordsInventoryInWarehousesChange")
		OR StructureTemporaryTables.Property("RegisterRecordsInventoryInWarehousesChange")
			AND Not StructureTemporaryTables.RegisterRecordsInventoryInWarehousesChange Then
	...
	If StructureTemporaryTables.Property("RegisterRecordsInventoryInWarehousesChange") Then
		...
		Query = New Query("DROP RegisterRecordsInventoryInWarehousesChange");
		Query.TempTablesManager = StructureTemporaryTables.TempTablesManager;
		Query.Execute();
...
Procedure OnWrite(Cancel, Replacing)
	...
	|		RegisterRecordsInventoryInWarehousesBeforeWrite.Products AS Products,
	...
	|		RegisterRecordsInventoryInWarehousesBeforeWrite.Ownership AS Ownership,
