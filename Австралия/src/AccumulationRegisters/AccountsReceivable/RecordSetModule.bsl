...
Procedure BeforeWrite(Cancel, Replacing)
	...
	If Not StructureTemporaryTables.Property("RegisterRecordsAccountsReceivableChange")
		...
		|	AccumulationRegisterAccountsReceivable.PresentationCurrency AS PresentationCurrency,
	...
	Else
		...
		|	AccumulationRegisterAccountsReceivable.PresentationCurrency,
	...
	If StructureTemporaryTables.Property("RegisterRecordsAccountsReceivableChange") Then
		...
		Query = New Query("DROP RegisterRecordsAccountsReceivableChange");
		Query.TempTablesManager = StructureTemporaryTables.TempTablesManager;
		Query.Execute();
...
Procedure OnWrite(Cancel, Replacing)
	...
	|		RegisterRecordsAccountsReceivableBeforeWrite.PresentationCurrency AS PresentationCurrency,
	...
	|		RegisterRecordsAccountsReceivableOnWrite.PresentationCurrency,
	...
	|	RegisterRecordsAccountsReceivableChange.PresentationCurrency,
	...
	If Not TypeOf(Filter.Recorder.Value) = Type("DocumentRef.SalesInvoice") Then
		InformationRegisters.TasksForUpdatingStatuses.RegisterSalesInvoicesBasedOnAccountsReceivableChange(StructureTemporaryTables.TempTablesManager);
	EndIf;
