...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.User <> Undefined Then
		...
		Title = NStr("ru = 'Пользовательские настройки'; en = 'User settings'; pl = 'Ustawienia użytkownika';es_ES = 'Configuraciones de usuario';es_CO = 'Configuraciones de usuario';tr = 'Kullanıcı ayarları';it = 'Impostazioni utente';de = 'Benutzereinstellungen'");
	Else
...
&AtClient
Procedure ReportAndInterfaceSettingsBeforeAddRow(Item, Cancel, Clone, Parent, IsFolder)
...
Procedure SettingsBeforeDelete(Item, Cancel)
	...
	QuestionText = NStr("ru = 'Очистить выбранные настройки?'; en = 'Do you want to clear the selected settings?'; pl = 'Czy usunąć wybrane ustawienia?';es_ES = '¿Eliminar las configuraciones seleccionadas?';es_CO = '¿Eliminar las configuraciones seleccionadas?';tr = 'Seçilen ayarları temizle?';it = 'Volete cancellare le impostazioni selezionate?';de = 'Löschen Sie die ausgewählten Einstellungen?'");
	...
	If SettingsGettingResult() = "NoIBUser" Then
		...
		ShowMessageBox(, StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'У выбранного пользователя ""%1"" не указан
			           ...
			           |es_CO = 'Para el usuario seleccionado ""%1"" no está especificado
			           | el usuario de la base de información, es imposible ver sus ajustes.
			           |Se puede resolver este problema en la tarjeta de este usuario.';
			           ...
			           |it = 'Impossibile vedere le impostazioni dell''utente selezionato ""%1""
			           |perchè non è mappato ad un utente infobase.
			           |Potete correggere questo nel profilo utente.';
...
Procedure CopyAllSettings(Command)
	...
	SettingsToCopy.Add("ReportSettings",      NStr("ru = 'Настройки отчетов'; en = 'Report settings'; pl = 'Ustawienia raportu';es_ES = 'Configuraciones de informe';es_CO = 'Configuraciones de informe';tr = 'Rapor ayarları';it = 'Impostazioni del report';de = 'Berichteinstellungen'"));
	SettingsToCopy.Add("InterfaceSettings", NStr("ru = 'Настройки внешнего вида'; en = 'Interface settings'; pl = 'Ustawienia wyglądu';es_ES = 'Configuraciones del aspecto';es_CO = 'Configuraciones del aspecto';tr = 'Görünüm ayarları';it = 'Impostazioni interfaccia';de = 'Aussehen Einstellungen'"));
	SettingsToCopy.Add("FormData",            NStr("ru = 'Данные форм'; en = 'Form data'; pl = 'Dane formularza';es_ES = 'Datos del formulario';es_CO = 'Datos del formulario';tr = 'Veri oluştur';it = 'Dati del modulo';de = 'Formulardaten'"));
	SettingsToCopy.Add("PersonalSettings", NStr("ru = 'Персональные настройки'; en = 'Personal settings'; pl = 'Personalne ustawienia';es_ES = 'Configuraciones personales';es_CO = 'Configuraciones personales';tr = 'Kişisel ayarlar';it = 'Impostazioni personalizzate';de = 'Persönliche Einstellungen'"));
	SettingsToCopy.Add("Favorites",             NStr("ru = 'Избранное'; en = 'Favorites'; pl = 'Ulubione';es_ES = 'Favoritos';es_CO = 'Favoritos';tr = 'Sık kullanılanlar';it = 'Preferiti';de = 'Favoriten'"));
	SettingsToCopy.Add("PrintSettings",       NStr("ru = 'Настройки печати'; en = 'Print settings'; pl = 'Ustawienia drukowania';es_ES = 'Imprimir configuraciones';es_CO = 'Imprimir configuraciones';tr = 'Yazdırma ayarları';it = 'Impostazioni di stampa';de = 'Druckeinstellungen'"));
	SettingsToCopy.Add("OtherUserSettings",
		NStr("ru = 'Настройки дополнительных отчетов и обработок'; en = 'Additional report and data processor settings'; pl = 'Ustawienia dodatkowych raportów i przetwarzania';es_ES = 'Configuraciones de informes adicionales y procesadores de datos';es_CO = 'Configuraciones de informes adicionales y procesadores de datos';tr = 'Ek rapor ve veri işlemcisi ayarları';it = 'Impostazioni report aggiuntivi ed elaboratori dati';de = 'Einstellungen von zusätzlichen Berichten und Datenprozessoren'"));
...
Procedure Clear(Command)
	...
	If SettingsTree.SelectedRows.Count() = 0 Then
		...
		ShowMessageBox(,NStr("ru = 'Необходимо выбрать настройки, которые требуется удалить.'; en = 'Please select the settings that you want to clear.'; pl = 'Wybierz ustawienia do usunięcia.';es_ES = 'Seleccionar las configuraciones para borrar.';es_CO = 'Seleccionar las configuraciones para borrar.';tr = 'Silmek için ayarları seçin.';it = 'Si prega di selezionare le impostazioni che volete annullare.';de = 'Wählen Sie die zu löschenden Einstellungen.'"));
		Return;
		
	EndIf;
	
	Notification = New NotifyDescription("ClearCompletion", ThisObject, SettingsTree);
	QuestionText = NStr("ru = 'Очистить выделенные настройки?'; en = 'Do you want to clear the selected settings?'; pl = 'Czy usunąć wybrane ustawienia?';es_ES = '¿Eliminar las configuraciones seleccionadas?';es_CO = '¿Eliminar las configuraciones seleccionadas?';tr = 'Seçilen ayarları temizle?';it = 'Volete cancellare le impostazioni selezionate?';de = 'Löschen Sie die ausgewählten Einstellungen?'");
...
Procedure ClearSettingsForSelectedUsers(Command)
	...
	QuestionText =
		NStr("ru = 'Очистить выделенные настройки?
		           ...
		           |es_CO = '¿Eliminar los ajustes seleccionados?
		           |Eso abrirá la pantalla de selección cuyos ajustes tienen que eliminarse.';
		           |tr = 'Seçilen ayarları temizle? 
		           |Ayarları temizlenecek olan kullanıcı seçim penceresi açılacaktır.';
		           |it = 'Volete cancellare le impostazioni selezionate?
		           |Questo aprirà un elenco dove potete selezionare gli utenti le cui impostazioni verranno cancellate.';
...
Procedure ClearAllSettings(Command)
	...
	QuestionText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Очистить все настройки у пользователя ""%1""?'; en = 'Do you want to clear all settings for user ""%1""?'; pl = 'Oczyść wszystkie ustawienia użytkownika ""%1""?';es_ES = '¿Eliminar todas las configuraciones del usuario ""%1""?';es_CO = '¿Eliminar todas las configuraciones del usuario ""%1""?';tr = '""%1"" kullanıcısının tüm ayarları temizlensin mi?';it = 'Volete cancellare tutte le impostazioni per l''utente ""%1""?';de = 'Löschen Sie alle Einstellungen des Benutzers ""%1""?'"), String(UserRef));
	
	QuestionButtons = New ValueList;
	QuestionButtons.Add("Clear", NStr("ru = 'Очистить'; en = 'Clear'; pl = 'Wyczyść';es_ES = 'Eliminar';es_CO = 'Eliminar';tr = 'Temizle';it = 'Annulla';de = 'Löschen'"));
	QuestionButtons.Add("Cancel",   NStr("ru = 'Отмена'; en = 'Cancel'; pl = 'Anuluj';es_ES = 'Cancelar';es_CO = 'Cancelar';tr = 'İptal et';it = 'Annulla';de = 'Abbrechen'"));
...
Procedure ClearReportAndInterfaceSettings(Command)
	...
	QuestionText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Очистить все настройки отчетов и внешнего вида у пользователя ""%1""?'; en = 'Do you want to clear all interface and report settings for user ""%1""?'; pl = 'Wyczyść wszystkie ustawienia sprawozdań i wyglądu użytkownika ""%1""?';es_ES = '¿Eliminar todas las configuraciones de informes y el aspecto del usuario ""%1""?';es_CO = '¿Eliminar todas las configuraciones de informes y el aspecto del usuario ""%1""?';tr = '""%1"" kullanıcısının tüm arayüz ve rapor ayarları temizlensin mi?';it = 'Volete cancellare tutta l''interfaccia e le impostazioni report per l''utente ""%1""?';de = 'Löschen Sie alle Einstellungen von Berichten und Aussehen von Benutzer ""%1""?'"),
		String(UserRef));
...
Procedure ClearSettingsForAllUsers(Command)
	...
	QuestionText =
		NStr("ru = 'Сейчас будут очищены все настройки всех пользователей.
		           ...
		           |¿Continuar?';
		           |es_CO = 'Todas las configuraciones del usuario se eliminarán.
		           |¿Continuar?';
		           |tr = 'Tüm kullanıcıların tüm ayarları silinecek.
		           |Devam edilsin mi?';
		           |it = 'Tutte le impostazioni per tutti gli utenti verranno annullate.
		           |Volete continuare?';
		           |de = 'Alle Benutzereinstellungen werden gelöscht.
		           |Fortsetzen?'");
	
	QuestionButtons = New ValueList;
	QuestionButtons.Add("ClearAll", NStr("ru = 'Очистить все'; en = 'Clear all'; pl = 'Odznacz wszystko';es_ES = 'Eliminar todo';es_CO = 'Eliminar todo';tr = 'Tümünü temizle';it = 'Cancella tutto';de = 'Alles löschen'"));
	QuestionButtons.Add("Cancel",      NStr("ru = 'Отмена'; en = 'Cancel'; pl = 'Anuluj';es_ES = 'Cancelar';es_CO = 'Cancelar';tr = 'İptal et';it = 'Annulla';de = 'Abbrechen'"));
...
Procedure CalculateSettingsCount()
	...
	If SettingsCount <> 0 Then
		Items.ReportSettingsPage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru='Настройки отчетов (%1)'; en = 'Report settings (%1)'; pl = 'Ustawienia raportu (%1)';es_ES = 'Configuraciones del informe (%1)';es_CO = 'Configuraciones del informe (%1)';tr = 'Rapor ayarları (%1)';it = 'Impostazioni dei report  (%1)';de = 'Berichteinstellungen (%1)'"), SettingsCount);
	Else
		Items.ReportSettingsPage.Title = NStr("ru = 'Настройки отчетов'; en = 'Report settings'; pl = 'Ustawienia raportu';es_ES = 'Configuraciones de informe';es_CO = 'Configuraciones de informe';tr = 'Rapor ayarları';it = 'Impostazioni del report';de = 'Berichteinstellungen'");
	EndIf;
	...
	If SettingsCount <> 0 Then
		Items.InterfacePage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Внешний вид (%1)'; en = 'Interface settings (%1)'; pl = 'Ustawienia interfejsu (%1)';es_ES = 'Aspecto (%1)';es_CO = 'Aspecto (%1)';tr = 'Düzenleme (%1)';it = 'Impostazioni interfaccia (%1)';de = 'Erscheinen (%1)'"), SettingsCount);
	Else
		Items.InterfacePage.Title = NStr("ru = 'Внешний вид'; en = 'Interface'; pl = 'Wygląd';es_ES = 'Aspecto';es_CO = 'Aspecto';tr = 'Dış görüntü';it = 'Interfaccia';de = 'Aussehen'");
	EndIf;
	...
	If SettingsCount <> 0 Then
		Items.OtherSettingsPage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Прочие настройки (%1)'; en = 'Other settings (%1)'; pl = 'Inne ustawienia (%1)';es_ES = 'Otras configuraciones (%1)';es_CO = 'Otras configuraciones (%1)';tr = 'Diğer ayarlar (%1)';it = 'Altre impostazioni (%1)';de = 'Andere Einstellungen (%1)'"), SettingsCount);
	Else
		Items.OtherSettingsPage.Title = NStr("ru = 'Прочие настройки'; en = 'Other settings'; pl = 'Inne ustawienia';es_ES = 'Otras configuraciones';es_CO = 'Otras configuraciones';tr = 'Diğer ayarlar';it = 'Altre impostazioni';de = 'Andere Einstellungen'");
	EndIf;
...
Procedure Attachable_ProcessNotification()
	...
	If Parameter.CopyAll Then
		...
		Else
			NotificationComment = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = '%1 скопированы %2'; en = '%1 copied to %2'; pl = '%1 skopiowano %2';es_ES = '%1 están copiadas %2';es_CO = '%1 están copiadas %2';tr = '%1 kopyalandı %2';it = '%1 copiate in %2';de = '%1 werden kopiert %2'"), SettingsNames, SettingsCopiedToNote);
		EndIf;
...
Procedure ClearSettingsForAllUsersCompletion(Response, AdditionalParameters) Export
	...
	ShowUserNotification(NStr("ru = 'Очистка настроек'; en = 'Clear settings'; pl = 'Oczyść ustawienia';es_ES = 'Eliminar configuraciones';es_CO = 'Eliminar configuraciones';tr = 'Temizleme ayarları';it = 'Cancella impostazioni';de = 'Einstellungen löschen'"), ,
		NStr("ru = 'Очищены все настройки всех пользователя'; en = 'All settings of all users are cleared.'; pl = 'Wszystkie ustawienia wszystkich użytkowników zostały oczyszczone';es_ES = 'Todas las configuraciones de todos los usuarios se han eliminado';es_CO = 'Todas las configuraciones de todos los usuarios se han eliminado';tr = 'Tüm kullanıcıların tüm ayarları silindi.';it = 'Tutte le impostazioni di tutti gli utenti sono state annullate.';de = 'Alle Einstellungen aller Benutzer sind gelöscht.'"), PictureLib.Information32);
...
Procedure ClearAllSettingsCompletion(Response, AdditionalParameters) Export
	...
	NoteText = NStr("ru = 'Очищены все настройки пользователя ""%1""'; en = 'All settings of user ""%1"" are cleared.'; pl = 'Wszystkie ustawienia użytkownika ""%1"" zostały oczyszczone';es_ES = 'Todas las configuraciones del usuario ""%1"" se han eliminado';es_CO = 'Todas las configuraciones del usuario ""%1"" se han eliminado';tr = '""%1"" kullanıcıya ait tüm ayarlar temizlendi';it = 'Tutte le impostazioni dell''utente""%1"" sono state annullate.';de = 'Alle Einstellungen des Benutzers ""%1"" sind gelöscht.'");
	NoteText = StringFunctionsClientServer.SubstituteParametersToString(NoteText, UserRef);
	ShowUserNotification(NStr("ru = 'Очистка настроек'; en = 'Clear settings'; pl = 'Oczyść ustawienia';es_ES = 'Eliminar configuraciones';es_CO = 'Eliminar configuraciones';tr = 'Temizleme ayarları';it = 'Cancella impostazioni';de = 'Einstellungen löschen'"), , NoteText, PictureLib.Information32);
...
Procedure ClearReportAndInterfaceSettingsCompletion(Response, AdditionalParameters) Export
	...
	NoteText = NStr("ru = 'Очищены все настройки отчетов и внешнего вида у пользователя ""%1""'; en = 'All interface and report settings of user ""%1"" are cleared.'; pl = 'Wszystkie ustawienia raportów i wyglądu użytkownika ""%1"" zostały oczyszczone';es_ES = 'Todas las configuraciones de informes y el aspecto del usuario ""%1"" se han eliminado';es_CO = 'Todas las configuraciones de informes y el aspecto del usuario ""%1"" se han eliminado';tr = 'Tüm rapor ayarları ve kullanıcı ""%1"" görünümleri temizlendi';it = 'Tutta l''interfaccia e le impostazioni di report dell''utente ""%1"" sono state annullate.';de = 'Alle Einstellungen von Berichten und Aussehen des Benutzers ""%1"" sind gelöscht.'");
...
Procedure NotifyDeletion(SettingsCount, SettingName = Undefined, UsersCount = Undefined)
	...
	If SettingsCount = 1
	   AND UsersCount = Undefined Then
		...
		NoteText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = '""%1"" очищена пользователю ""%2""'; en = '""%1"" cleared for user ""%2.""'; pl = '""%1"" została oczyszczona dla użytkownika ""%2""';es_ES = '""%1"" se ha eliminado para el usuario ""%2""';es_CO = '""%1"" se ha eliminado para el usuario ""%2""';tr = '""%1"" %2 için temizlendi';it = '""%1"" annullata per l''utente ""%2.""';de = '""%1"" wird für Benutzer gelöscht ""%2""'"), SettingName, String(UserRef));
		
	ElsIf UsersCount = Undefined Then
		NoteText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Очищено %1 пользователю ""%2""'; en = '%1 cleared for user ""%2.""'; pl = 'Oczyszczone %1 użytkownikowi ""%2""';es_ES = 'Está eliminado %1 al usuario ""%2""';es_CO = 'Está eliminado %1 al usuario ""%2""';tr = '""%1"" kullanıcı için silindi %2';it = '%1 annullata per l''utente ""%2.""';de = '%1 für Benutzer ""%2"" gelöscht'"), SubjectInWords, String(UserRef));
	EndIf;
	...
	If UsersCount <> Undefined Then
		...
		If SettingsCount = 1 Then
			NoteText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = '""%1"" очищена %2'; en = '""%1"" cleared for %2'; pl = '""%1"" wyczyszczono %2';es_ES = '""%1"" eliminado %2';es_CO = '""%1"" eliminado %2';tr = '""%1"" temizlendi %2';it = '""%1"" annullata per %2';de = '""%1"" gelöscht %2'"), SettingName, ClearSettingsForNote);
		Else
			NoteText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Очищено %1 %2'; en = '%1 cleared for %2'; pl = '%1 jest oczyszczony dla %2';es_ES = '%1 está eliminado para %2';es_CO = '%1 está eliminado para %2';tr = '%1, %2 için temizlendi';it = '%1 annullata per %2';de = '%1 ist verrechnet für %2'"), SubjectInWords, ClearSettingsForNote);
		EndIf;
		...
		If SettingsTree.CurrentData.Type = "PersonalOption" Then
			ShowMessageBox(,
				NStr("ru = 'Невозможно скопировать личный вариант отчета.
			               ...
			               |es_CO = 'Imposible copiar la opción de informe personal.
			               |Si quiere que la opción de informe personal esté disponible a otros usuarios, entonces usted necesita
			               | volver a guardarla con la marca ""Solo para el autor"" eliminada.';
			               |tr = '
			               ...
			               |it = 'Non è possibile copiare la versione personale del report.
			               |Per poter rendere disponibile la versione personale del report ad altri utenti, è necessario
			               |salvarlo nuovamente con il contrassegno ""Solo per l''autore"" rimosso.';
		...
		ElsIf SettingsTree.CurrentData.Type = "SettingsItemPersonal" Then
			ShowMessageBox(,
				NStr("ru = 'Невозможно скопировать настройку личного варианта отчета.
			               ...
			               |es_CO = 'Imposible copiar la configuración de la opción de informe personal.
			               |No se proporciona el copiar de las configuraciones de la opción de informe individual.';
			               |tr = 'Kişisel rapor seçeneğinin ayarını kopyalamak imkansız. 
			               |Tek tek rapor seçenek ayarlarının kopyalanması sağlanmamıştır.';
			               |it = 'Non è possibile copiare l''impostazione della versione personale del report.
			               |La copia delle impostazioni per le versioni personali del report non è prevista.';
