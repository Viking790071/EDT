...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Property("Title") Then
		Title = NStr("en = 'ToolTip'; ru = 'Подсказка';pl = 'Podpowiedź';es_ES = 'Información de herramienta';es_CO = 'Información de herramienta';tr = 'Araç ipucu';it = 'Consiglio';de = 'ToolTip'") + ": " + Parameters.Title;
	EndIf;
