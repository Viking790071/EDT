...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	SetAttributeValueByContacts(ThisObject, LocalityDetailed);
...
&AtClient
Procedure PresentationOfForeignAddressOnChange(Item)
...
Procedure AddressOnDateOnChange(Item)
	...
	If Not EnterNewAddress Then
		...
		If ValueIsFilled(Result.ValidTo) Then
			TextHistoricalAddress = " " + StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'действует по %1'; en = 'valid until %1'; pl = 'ważne do %1';es_ES = 'está vigente hasta %1';es_CO = 'está vigente hasta %1';tr = '%1 kadar geçerli';it = 'valido fino a %1';de = 'gültig bis %1'"), Format(Result.ValidTo - 10, "DLF=DD"));
		Else
...
&AtServer
Procedure SetAttributeValueByContacts(AddressInfo, AddressData)
