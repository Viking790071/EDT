...
Procedure CreditorsOnTermsDetailsClick(Item)
	...
	ReportProperties = New Structure;
	ReportProperties.Insert("ReportName", "AccountsPayableAging");
	ReportProperties.Insert("VariantKey", "Statement");
...
Procedure RefreshChartAndWidgetCreditorsByDeadlines()
	...
	If SelectionTotal.Next() Then
		...
		Items.DecorationCreditorsLessThan7Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtLessThan7);
		Items.DecorationCreditorsLessThan30Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtLessThan30);
		Items.DecorationCreditorsMoreThan31Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtMoreThan31);
...
Procedure RefreshCreditorsWidget()
	...
	If SelectionTotals.Next() Then
		...
		Items.DecorationCreditorsAdvanceTotal.Title = DriveServer.GenerateTitle(SelectionTotals.AdvanceAmount);
	Else
