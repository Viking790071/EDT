...
Procedure DebitorsOnTermsDetailsClick(Item)
	...
	ReportProperties = New Structure;
	ReportProperties.Insert("ReportName", "AccountsReceivableAging");
	ReportProperties.Insert("VariantKey", "Statement");
...
Procedure RefreshChartDebitors()
	...
	While Selection.Next() Do
		...
		ToolTip = Selection.CounterpartyPresentation + ": " + Selection.Debt;
...
Procedure RefreshChartAndWidgetDebitorsByDeadlines()
	...
	DebtLessThan7 = NStr("en = '1 - 7 days'; ru = '1 – 7 дней';pl = '1 - 7 dni';es_ES = '1 - 7 días';es_CO = '1 - 7 días';tr = '1 - 7 gün';it = '1-7 giorni';de = '1–7 Tage'");
	DebtLessThan30 = NStr("en = '8 - 30 days'; ru = '8 - 30 дней';pl = '8 - 30 dni';es_ES = '8 - 30 días';es_CO = '8 - 30 días';tr = '8 - 30 gün';it = '8 - 30 giorni';de = '8–30 Tage'");
	DebtMoreThan31 = NStr("en = '31 + days'; ru = '31+ дней';pl = '31 + dni';es_ES = '31 + días';es_CO = '31 + días';tr = '31+ gün';it = 'oltre un mese';de = '31 + Tage'");
	...
	If SelectionTotal.Next() Then
		...
		Items.DecorationDebitorsLessThan7Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtLessThan7);
		Items.DecorationDebitorsLessThan30Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtLessThan30);
		Items.DecorationDebitorsMoreThan31Total.Title = DriveServer.GenerateTitle(SelectionTotal.DebtMoreThan31);
		
		Series = ChartDebitorsOnTerms.Series.Add(DebtLessThan7);
		Series.Color = DriveServer.ColorForMonitors("Green");
		ToolTip = NStr("en = '1 - 7 days:'; ru = '1 - 7 дней:';pl = '1 - 7 dni:';es_ES = '1 - 7 días:';es_CO = '1 - 7 días:';tr = '1 - 7 gün:';it = '1 - 7 giorni:';de = '1–7 Tage:'") + " " + SelectionTotal.DebtLessThan7;
		...
		Series.Color = DriveServer.ColorForMonitors("Yellow");
		ToolTip = NStr("en = '8 - 30 days:'; ru = '8 - 30 дней:';pl = '8 - 30 dni:';es_ES = '8 - 30 días:';es_CO = '8 - 30 días:';tr = '8 - 30 gün:';it = '8 - 30 giorni:';de = '8–30 Tage:'") + " " + SelectionTotal.DebtLessThan30;
		...
		Series.Color = DriveServer.ColorForMonitors("Red");
		ToolTip = NStr("en = '31 + days:'; ru = '31+ дней:';pl = '31 + dni:';es_ES = '31 + días:';es_CO = '31 + días:';tr = '31+ gün:';it = 'oltre un mese:';de = '31 + Tage:'") + " " + SelectionTotal.DebtMoreThan31;
...
Procedure RefreshDebitorsWidget()
	...
	If SelectionTotals.Next() Then
		...
		Items.DecorationDebitorsAdvanceTotal.Title = DriveServer.GenerateTitle(SelectionTotals.AdvanceAmount);
	Else
...
Function GetReportUserSettings(ReportName, ParametersAndSelections, VariantName = "") Export
	...
	For Each FilterStructure In ParametersAndSelections Do
		...
		Else
			CommonClientServer.SetFilterItem(DataCompositionSettingsComposer.Settings.Filter, 
