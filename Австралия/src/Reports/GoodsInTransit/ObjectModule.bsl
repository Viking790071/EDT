...
Function PrepareReportParameters(ReportSettings)
	...
	Period  = Date(1,1,1);
	TitleOutput = False;
	Title = NStr("en = 'Goods in transit'; ru = 'Товары в пути';pl = 'Towary w tranzycie';es_ES = 'Mercancías en tránsito';es_CO = 'Mercancías en tránsito';tr = 'Transit mallar';it = 'Merci in transito';de = 'Waren in Transit'");
