...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	DriveReports.CustomizeDynamicPeriod(DataCompositionSchema, ReportParameters, False);
...
Function PrepareReportParameters(ReportSettings)
	...
	ReportParameters.Insert("ReportId"      , "AccountsReceivableTrend");
...
Function GetExternalDataSets(ReportParameters, CompositionTemplate) Export
	...
	TableDebt.Columns.Add("Currency");
	...
	Else
		Periodicity = DriveReports.GetPeriodicityValue(ReportParameters.BeginOfPeriod, ReportParameters.EndOfPeriod);
	EndIf;
...
Function GetDebt(ReportParameters, EndDate)
	...
	|	AccountsReceivableBalances.PresentationCurrency AS Currency,
	...
	|	AccountsReceivable.Currency AS Currency,
