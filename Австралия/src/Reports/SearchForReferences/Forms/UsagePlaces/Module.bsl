...
Procedure OnOpen(Cancel)
	...
	Representation.Picture                       = PictureLib.TimeConsumingOperation48;
	Representation.Text                          = NStr("en = 'Generating the report...'; ru = 'Отчет формируется...';pl = 'Generowanie sprawozdania...';es_ES = 'Generando el informe...';es_CO = 'Generando el informe...';tr = 'Rapor oluşturma...';it = 'Generazione del report ...';de = 'Den Bericht erstellen...'");
