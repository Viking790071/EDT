...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	UserSettingsItem = SettingsComposer.UserSettings.Items.Find(UserSettingID);
	...
	ParameterValue = SettingsComposer.Settings.DataParameters.FindParameterValue(ParemeterCompany);
