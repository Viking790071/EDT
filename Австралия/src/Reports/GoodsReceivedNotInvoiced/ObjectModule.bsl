...
Function PrepareReportParameters(ReportSettings)
	...
	Title = NStr("en = 'Goods received not invoiced'; ru = 'Неотфактурованные поступления';pl = 'Dostawy niefakturowane';es_ES = 'Mercancías recibidas no facturadas';es_CO = 'Mercancías recibidas no facturadas';tr = 'Teslim alınan ama faturalanmayan mallar';it = 'Merci ricevute non fatturate';de = 'Erhaltene, aber nicht fakturierte Waren'");
	...
	ReportParameters.Insert("ReportId",			"GoodsReceivedNotInvoiced");
