...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = NStr("en = 'Kit order statement'; ru = 'Ведомость заказа на комплектацию';pl = 'Analiza zamówienia zestawu';es_ES = 'Declaración de pedido del Kit';es_CO = 'Declaración de pedido del Kit';tr = 'Set siparişi ekstresi';it = 'Resoconto ordine kit';de = 'Auszug Kit-Auftrag'");
	...
	ReportParameters.Insert("ReportId" , "KitOrders");
