...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = Nstr("en = 'Statement of tax account'; ru = 'Расчеты по налогам';pl = 'Rozliczenie podatkowe';es_ES = 'Declaración de la cuenta de impuestos';es_CO = 'Declaración de la cuenta de impuestos';tr = 'Vergi hesap tablosu';it = 'Estratto del conto delle imposte';de = 'Nachweis der Steuerbilanz'");
	...
	ReportParameters.Insert("ReportId"      , "StatementOfTaxAccount");
