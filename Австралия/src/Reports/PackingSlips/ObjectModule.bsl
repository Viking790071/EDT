...
Function PrepareReportParameters(ReportSettings)
	...
	TitleOutput = False;
	Title = NStr("en = 'Packing slips'; ru = 'Упаковочные листы';pl = 'Listy przewozowe';es_ES = 'Albaranes de entrega';es_CO = 'Albaranes de entrega';tr = 'Sevk irsaliyeleri';it = 'Packing list';de = 'Packzettel'");
	...
	ReportParameters.Insert("ReportId", "PackingSlips");
