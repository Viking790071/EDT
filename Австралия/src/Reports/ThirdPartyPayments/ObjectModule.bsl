...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1, 1, 1);
	TitleOutput = False;
	Title = NStr("en = 'Third-party payments'; ru = 'Сторонние платежи';pl = 'Płatności strony trzeciej';es_ES = 'Pagos de terceros';es_CO = 'Pagos de terceros';tr = 'Üçüncü taraf ödemeleri';it = 'Pagamenti terze parti';de = 'Zahlungen der Dritten'");
	...
	ReportParameters.Insert("ReportId",			"ThirdPartyPayments");
