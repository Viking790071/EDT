...
Function PrepareReportParameters(ReportSettings)
	...
	Title = NStr("en = 'Goods invoiced not received'; ru = 'Товары к получению';pl = 'Towary zafakturowane ""w drodze""';es_ES = 'Los productos facturados no recibidos';es_CO = 'Los productos facturados no recibidos';tr = 'Faturalanan ama teslim alınmayan mallar';it = 'Merci fatturate non ricevute';de = 'Fakturierte, aber nicht erhaltene Waren'");
	...
	ReportParameters.Insert("ReportId"       , "GoodsInvoicedNotReceived");
