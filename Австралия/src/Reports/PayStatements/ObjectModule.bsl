...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = Nstr("en = 'Salary payable'; ru = 'Зарплата к выплате';pl = 'Wynagrodzenie płatne';es_ES = 'Salario a pagar';es_CO = 'Salario a pagar';tr = 'Ödenecek Maaş';it = 'Stipendi da pagare';de = 'Gehaltszahlung'");
	...
	ReportParameters.Insert("ReportId"      , "Payroll");
