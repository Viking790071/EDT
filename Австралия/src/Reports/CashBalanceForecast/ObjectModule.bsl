...
Function PrepareReportParameters(ReportSettings)
	...
	ParameterTotalsCurrency = ReportSettings.DataParameters.FindParameterValue(New DataCompositionParameter("CurrencyTotals"));
	If ParameterTotalsCurrency <> Undefined
		AND ParameterTotalsCurrency.Use Then
		
		ParameterTotalsCurrency.UserSettingPresentation = NStr("en = 'Total currency'; ru = 'Валюта итогов';pl = 'Łącznie waluta';es_ES = 'Moneda total';es_CO = 'Moneda total';tr = 'Toplamın para birimi';it = 'Totale valuta';de = 'Gesamtwährung'");
	...
	ReportParameters.Insert("ReportId"            , "CashBalanceForecast");
...
Procedure SetDataParameters(ReportSettings)
	...
	ParametersMap.Insert(New DataCompositionParameter("BalanceOnCurrentDate"), NStr("en = 'Balance on current date'; ru = 'Остаток на текущую дату';pl = 'Saldo na bieżącą datę';es_ES = 'Saldo en la fecha actual';es_CO = 'Saldo en la fecha actual';tr = 'Geçerli tarihteki bakiye';it = 'Saldo alla data corrente';de = 'Stand zum aktuellen Datum'"));
