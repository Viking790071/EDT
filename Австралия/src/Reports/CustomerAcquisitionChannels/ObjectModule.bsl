...
Function PrepareReportParameters(ReportSettings)
	...
	Title = NStr("en = 'Customer acquisition channels'; ru = 'Источники привлечения покупателей';pl = 'Kanały pozyskiwania nabywców';es_ES = 'Canales de la adquisición del cliente';es_CO = 'Canales de la adquisición del cliente';tr = 'Müşteri edinme kanalları';it = 'Canali di acquisto del cliente';de = 'Kundenakquisitionskanäle'");
	...
	ReportParameters.Insert("ReportId"       , "CustomerAcquisitionChannels");
