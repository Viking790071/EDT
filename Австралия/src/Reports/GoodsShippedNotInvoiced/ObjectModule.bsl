...
Function PrepareReportParameters(ReportSettings)
	...
	Title = NStr("en = 'Goods shipped not invoiced'; ru = 'Неотфактурованные поставки';pl = 'Towary wysłane niezafakturowane';es_ES = 'Mercancías enviadas no facturadas';es_CO = 'Mercancías enviadas no facturadas';tr = 'Sevk edilmiş ama faturalanmamış mallar';it = 'Merci spedite non fatturate';de = 'Gelieferte nicht fakturierte Waren'");
	...
	ReportParameters.Insert("ReportId"       , "GoodsShippedNotInvoiced");
