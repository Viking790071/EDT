...
Function PrepareReportParameters(ReportSettings)
	...
	TitleOutput = False;
	Title = NStr("en = 'Customer-provided inventory statement'; ru = 'Ведомость ТМЦ от покупателя';pl = 'Zestawienie zapasów od nabywcy';es_ES = 'Declaración de inventario proporcionada por el Cliente';es_CO = 'Declaración de inventario proporcionada por el Cliente';tr = 'Müşteri tarafından sağlanan stok ekstresi';it = 'Resoconto inventario personalizzato';de = 'Auszug Kundenseitige Komponenten'");
	...
	ReportParameters.Insert("ReportId", "CustomerProvidedInventoryStatement");
