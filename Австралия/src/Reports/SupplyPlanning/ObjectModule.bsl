...
Function PrepareReportParameters(ReportSettings)
	...
	Period  = Date(1,1,1);
	TitleOutput = False;
	Nstr ("en = 'Inventory demand'; ru = 'Потребность в запасах';pl = 'Zapotrzebowanie na zapasy';es_ES = 'Demanda de inventario';es_CO = 'Demanda de inventario';tr = 'Stok talebi';it = 'Fabbisogno di scorte';de = 'Bestandsbedarf'");
	...
	ReportParameters.Insert("ReportId" , "SupplyPlanning");
