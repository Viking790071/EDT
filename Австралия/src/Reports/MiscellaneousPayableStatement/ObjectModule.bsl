...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = NStr("en = 'Miscellaneous payable statement'; ru = 'Расчеты по прочим операциям';pl = 'Różne zobowiązania';es_ES = 'Declaración de otras operaciones';es_CO = 'Declaración de otras operaciones';tr = 'Çeşitli borçlar ekstresi';it = 'Resoconto vari debiti da pagare';de = 'Auszug diverse Zahlungen'");
	...
	ReportParameters.Insert("ReportId",			"MiscellaneousPayableStatement");
