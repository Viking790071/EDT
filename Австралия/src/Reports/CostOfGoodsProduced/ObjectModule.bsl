...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = NStr("en = 'Cost of goods produced'; ru = 'Себестоимость выпуска';pl = 'Koszty własne produkcji';es_ES = 'Coste de los mercancías producidas';es_CO = 'Coste de los mercancías producidas';tr = 'Üretilen malların maliyeti';it = 'Costi di produzione';de = 'Kosten von hergestellten Waren'");
