...
Function PrepareReportParameters(ReportSettings)
	...
	Period = Date(1,1,1);
	TitleOutput = False;
	Title = NStr("en = 'Cost of goods assembled'; ru = 'Себестоимость собранных товаров';pl = 'Koszt własny zebranych towarów';es_ES = 'Coste de las mercancías ensambladas';es_CO = 'Coste de las mercancías ensambladas';tr = 'Monte edilen malların maliyeti';it = 'Costo merci assemblate';de = 'Kosten von zusammengestellten Waren'");
	...
	ReportParameters.Insert("ReportId"			, "CostOfGoodsAssembled");
