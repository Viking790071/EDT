...
Function PrepareReportParameters(ReportSettings)
	...
	Title = NStr("en = 'Goods invoiced not shipped'; ru = 'Товары к отгрузке';pl = 'Towary zafakturowane, nie wysłane';es_ES = 'Productos facturados no enviados';es_CO = 'Productos facturados no enviados';tr = 'Faturalanmış ama sevk edilmemiş mallar';it = 'Merci fatturate non spedite';de = 'Fakturierte, aber nicht gelieferte Waren'");
	...
	ReportParameters.Insert("ReportId"       , "GoodsInvoicedNotShipped");
