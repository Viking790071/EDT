...
Function PrepareReportParameters(ReportSettings)
	...
	TitleOutput = False;
	Title = NStr("en = 'Earnings and deductions'; ru = 'Начисления и удержания';pl = 'Zarobki i potrącenia';es_ES = 'Ingresos y deducciones';es_CO = 'Ingresos y deducciones';tr = 'Kazançlar ve kesintiler';it = 'Compensi e trattenute';de = 'Bezüge und Abzüge'");
	...
	ReportParameters.Insert("ReportId"      , "EarningsAndDeductions");
