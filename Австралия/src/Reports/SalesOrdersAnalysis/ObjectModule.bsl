...
Function PrepareReportParameters(ReportSettings)
	...
	TitleOutput = False;
	Title = NStr("en = 'Sales orders analysis'; ru = 'Анализ заказов покупателей';pl = 'Analiza zamówień sprzedaży';es_ES = 'Análisis de órdenes de ventas';es_CO = 'Análisis de órdenes de ventas';tr = 'Satış siparişleri analizi';it = 'Analisi ordini cliente';de = 'Analyse der Kundenaufträge'");
