...
//
&AtServer
Function GetCashRegisterAndTerminalDefault()
...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	If ParametersStructure.CashCR <> Undefined AND 
		...
		OpenForm("Document.SalesSlip.Form.DocumentForm_CWP", BATCHParameters);
		
	Else
		
		OpenForm("Document.SalesSlip.Form.DocumentForm_CWP_WindowPettyCashSelection", New Structure("ParametersStructure", ParametersStructure), CommandExecuteParameters.Source, CommandExecuteParameters.Uniqueness, CommandExecuteParameters.Window, CommandExecuteParameters.URL);
