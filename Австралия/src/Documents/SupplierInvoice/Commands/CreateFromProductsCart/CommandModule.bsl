...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	ElsIf CommandExecuteParameters.Source.FormName = "Catalog.Products.Form.CartForm" Then
		...
		If ValueIsFilled(CommandExecuteParameters.Source.FormOwner.FilterWarehouse) Then
			FillingValues.Insert("StructuralUnit", CommandExecuteParameters.Source.FormOwner.FilterWarehouse);
		EndIf;
	EndIf;
	...
	OpenForm("Document.SupplierInvoice.ObjectForm", New Structure("FillingValues", FillingValues));
