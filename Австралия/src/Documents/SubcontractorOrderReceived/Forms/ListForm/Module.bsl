...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	UseStatuses = Constants.UseSubcontractorOrderReceivedStatuses.Get();
	...
	DriveServer.AddChangeStatusCommands(ThisObject, "GroupChangeStatus", "SubcontractorOrderReceivedStatuses");
...
Procedure OnLoadDataFromSettingsAtServer(Settings)
	...
	Else
		FilterActuality = "All";
		FilterState = Catalogs.SubcontractorOrderReceivedStatuses.EmptyRef();
...
Procedure NotificationProcessing(EventName, Parameter, Source)
	...
	If EventName = "Write_SubcontractorOrderReceivedStates" Then
		PaintList();
	ElsIf EventName = "Write_SubcontractorInvoiceIssued" Then
		Items.List.Refresh();
	EndIf;
...
Procedure Attachable_ExecuteChangeStatusCommand(Command)
	...
	DriveClient.ExecuteChangeStatusCommand(Command, Items.List, "SubcontractorOrderReceivedStatuses");
